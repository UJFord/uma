...
if (isset($_GET['tribe_id'])) {
	...
	$query = pg_query($connection, "select tribe.tribe_id, tribe.tribe_name, tribe.tribe_image, tribe_practices.tribe_practice_id, practices.practices_name, practices.practices_description, practices.practices_image, tribe_ritual.tribe_ritual_id, ritual.ritual_name, ritual.ritual_description, ritual.ritual_image from tribe left join tribe_practices on tribe.tribe_practice_id = tribe_practices.tribe_practice_id left join practices on tribe_practices.practices_id = practices.practices_id left join tribe_ritual on tribe.tribe_ritual_id = tribe_ritual.tribe_ritual_id left join ritual on tribe_ritual.ritual_id = ritual.ritual_id where tribe_id = '$tribe_id'");
