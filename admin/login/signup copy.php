...
<body>
    ...
    <div class="login">
        ...
        <form action="" autocomplete="off" method="POST" class="text-center">
            ...
            Confirm Password: <br>
            <input class="input" type="password" name="password" placeholder="Retype Password" required> <br><br>
...
if (isset($_POST['submit'])) {
    ...
    // incase if the client want to add userID example sa msu kay 2020-1225
