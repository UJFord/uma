<div id="button-div" class="fixed-bottom d-flex justify-content-end">
    ...
    <div id="edit-btn-box" class="m-3">
        <button id="apply-btn" type="submit" name="save_crop" class="btn btn-success px-3 py-2 me-1" onclick="validateAndSubmitForm()"><i class="fa-solid fa-check me-1"></i>Add</button>
    </div>
</div>
