		...
		<section id="nav-cards" class="p-0 m-0 col col-md-4 col-lg-9 col-xl-10">
			<div class="py-3 px-4">
				...
				<div id="crop-cards" class="row">
					...
					?>
					<?php
					$result = pg_query($connection, "select * from farming_practice");
					...
					?>
							...
							<div class="card-container col-6 col-md-4 col-lg-2 p-2">
								<?php
								if ($farming_practice_id !== 'Empty') {
								?>
									<a href="farming.php?farming_practice_id=<?php echo $farming_practice_id; ?>" class="crop-card py-3 px-1 d-flex justify-content-center align-items-end" style="
								...
								">
										<div class="crop-card-text row w-100 d-flex flex-row justify-content-between align-items-center">
											<!-- Farming name -->
											<h4 class="crop-name col-6"><?php echo ucfirst($farming_practice_name); ?></h4>
											<!-- arrow -->
